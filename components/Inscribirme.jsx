    ...
    tab1: (
      <div class="flex justify-center my-10">
                <div class="p-4 w-3/5 rounded-2xl overflow-hidden shadow-md border border-gray-500 h-60 text-center flex flex-col items-center justify-center gap-3">
                  ...
                  <p class="text-[#f5f5dc] mt-2 text-2xl md:text-5xl font-semibold">
                    4.400 USD
                  </p>
  ...
  return (
    <div className="bg-[#030016]">
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        <h2 className="text-center text-2xl md:text-5xl font-medium text-[#f5f5dc] py-12 tracking-wider	">
        ...
        <div className="md:w-2/3 mx-auto p-6 md:p-10 bg-grey rounded-2xl shadow-lg">
          <div className="flex justify-center space-x-4">
            <button
              className={`px-4 md:px-16 text-base py-4 rounded-full border border-[#4C1C24] ${
                activeTab === "tab1" 
                  ? "bg-[#4C1C24] text-[#f5f5dc]"
                  : "bg-grey text-[#f5f5dc]"
              }`}
          ...
          <div>
            ...
            <div>
              <h2 className="text-center text-2xl font-bold py-6 text-[#f5f5dc] font-medium">
                ¿Qué incluye?
              </h2>
              <div className="text-base flex gap-4 pb-4">
                ...
                <p className="text-[#f5f5dc] ">Acceso por tiempo ilimitado al contenido del programa.</p>
                
              </div>
              <div className="text-base flex gap-4 pb-4">
                <img src="https://cdn.prod.website-files.com/65c39c8aee4ff1f31a820ce3/65d14ca8e2e33453afcfd8b5_info-success%20(1).svg" alt="" />
                <p className="text-[#f5f5dc] ">Acceso a 16 masterclass con emprendedores top.</p>
                
              </div>
              <div className="text-base flex gap-4 pb-4">
                <img src="https://cdn.prod.website-files.com/65c39c8aee4ff1f31a820ce3/65d14ca8e2e33453afcfd8b5_info-success%20(1).svg" alt="" />
                <p className="text-[#f5f5dc] ">Mentoría de Expertos líderes en la industria (Q&As semanales).</p>
                
              </div>
              <div className="text-base flex gap-4 pb-4">
                <img src="https://cdn.prod.website-files.com/65c39c8aee4ff1f31a820ce3/65d14ca8e2e33453afcfd8b5_info-success%20(1).svg" alt="" />
                <p className="text-[#f5f5dc] ">Acceso a sesiones 1:1 con tus mentores del programa. Las que
                necesites para poder avanzar.</p>
                
              </div>
              <div className="text-base flex gap-4 pb-4">
                <img src="https://cdn.prod.website-files.com/65c39c8aee4ff1f31a820ce3/65d14ca8e2e33453afcfd8b5_info-success%20(1).svg" alt="" />
                <p className="text-[#f5f5dc] ">Acceso a +300 videos de entrenamiento de 10-20 minutos para que
              ...
              <div className="text-base flex gap-4 pb-4">
                <img src="https://cdn.prod.website-files.com/65c39c8aee4ff1f31a820ce3/65d14ca8e2e33453afcfd8b5_info-success%20(1).svg" alt="" />
                <p className="text-[#f5f5dc] ">Acceso a recursos y bibliografía recomendada.</p>
                
              </div>
              <div className="text-base flex gap-4 pb-4">
                <img src="https://cdn.prod.website-files.com/65c39c8aee4ff1f31a820ce3/65d14ca8e2e33453afcfd8b5_info-success%20(1).svg" alt="" />
                <p className="text-[#f5f5dc] ">Acceso a GrowthX Community en Circle para que puedas pitchear tu
                idea.</p>
                
              </div>
              <div className="text-base flex gap-4 pb-4">
                <img src="https://cdn.prod.website-files.com/65c39c8aee4ff1f31a820ce3/65d14ca8e2e33453afcfd8b5_info-success%20(1).svg" alt="" />
                <p className="text-[#f5f5dc] ">Acceso a la comunidad VIP de GrowthX por 1 año.</p>
                
              </div>
              <div className="text-base flex gap-4 pb-4">
                <img src="https://cdn.prod.website-files.com/65c39c8aee4ff1f31a820ce3/65d14ca8e2e33453afcfd8b5_info-success%20(1).svg" alt="" />
                <p className="text-[#f5f5dc] ">Certificación de ‘Especialista’ al finalizar el programa con
                éxito.</p>
          ...
          <div>
            <h2 className="text-center text-2xl font-bold py-5 text-[#f5f5dc] font-medium">
            ...
            <div className="text-center py-10">
              <button class="btn bg-[#4C1C24] px-16 rounded-lg py-3 text-base text-[#f5f5dc]">Aplica ahora</button>
            </div>
            <div className="py-8 text-center">
                <div className="items-center flex justify-center gap-4">
                  ...
                  <p className="text-[#f5f5dc] text-xl font-semibold">Comienza el 22 de Julio</p>                  
                </div>
                <p className="py-4 text-[#f5f5dc]">Cierre de inscripciones: 16 de Julio</p>
            </div>
          </div>
        </div>
      </div>
