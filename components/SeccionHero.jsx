const SeccionHero = () => {
    return (
      ...
      <div className="flex flex-col items-center w-4/5 mx-auto justify-items-center">
        ...
        <button type="button" class="text-white bg-skyblue  focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:hover:bg-skyblue">Inscribirme ahora</button>
      </div>
    </section>
    );
  };
